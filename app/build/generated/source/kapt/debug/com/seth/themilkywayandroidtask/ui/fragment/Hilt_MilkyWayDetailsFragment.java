...
public abstract class Hilt_MilkyWayDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MilkyWayDetailsFragment() {
    super();
  }

  Hilt_MilkyWayDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MilkyWayDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMilkyWayDetailsFragment(UnsafeCasts.<MilkyWayDetailsFragment>unsafeCast(this));
    }
  }
