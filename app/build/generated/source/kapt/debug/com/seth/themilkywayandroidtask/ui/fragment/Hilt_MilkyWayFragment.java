...
public abstract class Hilt_MilkyWayFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MilkyWayFragment() {
    super();
  }

  Hilt_MilkyWayFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MilkyWayFragment_GeneratedInjector) this.generatedComponent()).injectMilkyWayFragment(UnsafeCasts.<MilkyWayFragment>unsafeCast(this));
    }
  }
